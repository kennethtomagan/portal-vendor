...
import BlockEditorContainer from '@automattic/isolated-block-editor/src/components/block-editor-container';
import withRegistryProvider from '@automattic/isolated-block-editor/src/components/with-registry-provider';
import useEditorSetup from '@automattic/isolated-block-editor/src/components/editor-setup';
import PatternMonitor from '@automattic/isolated-block-editor/src/components/pattern-monitor';
import ContentSaver from '@automattic/isolated-block-editor/src/components/content-saver';
import registerApiHandlers from '@automattic/isolated-block-editor/src/components/api-fetch';
import storeHotSwapPlugin from '@automattic/isolated-block-editor/src/store/plugins/store-hot-swap';
import DocumentSection from '@automattic/isolated-block-editor/src/components/document';
import ToolbarSlot from '@automattic/isolated-block-editor/src/components/block-editor-toolbar/slot';
import ActionArea from '@automattic/isolated-block-editor/src/components/action-area';
import FooterSlot from '@automattic/isolated-block-editor/src/components/footer-slot';

// Export library components
import EditorLoaded from '@automattic/isolated-block-editor/src/components/editor-loaded';
import EditorHeadingSlot from '@automattic/isolated-block-editor/src/components/editor-heading-slot';

// A fake edit-post store is needed
import '@automattic/isolated-block-editor/src/store/edit-post';
import '@automattic/isolated-block-editor/src/style.scss';

/** @typedef {import('@automattic/isolated-block-editor/src/components/block-editor-toolbar/more-menu').OnMore} OnMore */
/** @typedef {import('@automattic/isolated-block-editor/src/store/editor/reducer').Pattern} Pattern */
/** @typedef {import('@automattic/isolated-block-editor/src/components/block-editor-contents/index').OnUpdate} OnUpdate */
